    ...
    <section id="plans" className="min-h-screen bg-gradient-to-r from-green-500 to-yellow-500 dark:from-gray-800 dark:to-gray-900 flex flex-col justify-center items-center text-white p-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
        <div className="bg-white/10 p-4 md:p-6 rounded-lg border-2 border-purple-500">
          <h3 className="text-xl md:text-2xl font-semibold mb-2 md:mb-4">1️⃣Free Trial</h3>
          <p className="text-sm md:text-base">✅ Basic features <br />✅ limited palettes.</p>
        ...
        <div className="bg-white/10 p-4 md:p-6 rounded-lg border-2 border-blue-500">
          <h3 className="text-xl md:text-2xl font-semibold mb-2 md:mb-4">2️⃣ Basic</h3>
          <p className="text-sm md:text-base">✅ Unlimited palettes <br />✅ save up to 10 palettes.</p>
        ...
        <div className="bg-white/10 p-4 md:p-6 rounded-lg border-2 border-green-500">
          <h3 className="text-xl md:text-2xl font-semibold mb-2 md:mb-4">3️⃣Unique</h3>
          <p className="text-sm md:text-base">✅ Custom gradients <br />✅ export to CSS/SCSS.</p>
        ...
        <div className="bg-white/10 p-4 md:p-6 rounded-lg border-2 border-yellow-500">
          <h3 className="text-xl md:text-2xl font-semibold mb-2 md:mb-4">4️⃣ Nova</h3>
          <p className="text-sm md:text-base">✅ AI-generated palettes <br />✅ priority support.</p>
